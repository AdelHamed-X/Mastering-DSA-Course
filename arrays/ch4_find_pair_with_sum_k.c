...
void findDuplicatesHash(struct Array *arr)
{
    int high = arr->length + 2, i;
    int hash[high];
...
void findPairHash(struct Array *arr, int k)
{
    int high = arr->length + 1, i, compl;
    int hash[high];
